package io.chillingchat.android.presenter;
...
import io.chillingchat.android.model.AuthModel;
...
import static io.chillingchat.android.view.AuthActivity.adminMode;
    ...
    public void checkEmailAddress(final String email) {
        ...
        if(email == null || email.equals("")) {
            ...
            if (!email.contains("@khu.ac.kr")) {
                authView.showSnackBar("경희대학교 웹메일(@khu.ac.kr)이 아닙니다", 3000, true, true);
                authView.hideProgressBar();
                authView.enableSendBtn();
            } else {
                //check email already exist or not.
